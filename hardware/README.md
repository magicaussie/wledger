...
**Note:** The holes for the connectors/wires at the ends of each PCB are a bit small. This design works great, but you may want to modify the PCB to add larger holes (I will do this myself at some point. When I do, I will remove this notice.)
