...
3. This visual tool allows you to add containers and map LEDs to virtual "Bins" using different layouts:
...
4. Use the **Auto Map** feature or manually click to define the flow of data from your controller to each LED.
5. Click **"Save"**.
...
2. Click **"Create Wall"**.
3. Give your Wall a name (e.g., "Main Storage Wall") and (optional) description.
4. Once created, click **"Edit Wall"** to add containers to this Wall.
...
* **[Hardware Guide](../Hardware/build-guide.md):** Detailed advice on building your own LED storage cabinets.
* **[Developer Guide](./developer-guide.md):** Learn how the code works and how to contribute.
* **[Feature Guide](./feature-guide/inventory.md):** Learn about all of WLEDger's features, what they do, and how to use them.
